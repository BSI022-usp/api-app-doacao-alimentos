...
export class MarcasController {
  ...
  @ApiOperation({
    ...
    description: 'Retorna uma lista completa com todas as marcas cadastradas no sistema.',
  })
  ...
  @ApiOperation({
    ...
    description: 'Procura e retorna os detalhes de uma marca específica com base no nome fornecido como parâmetro.',
  })
